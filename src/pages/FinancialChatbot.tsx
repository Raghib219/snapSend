    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-4">
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-2xl border-0 min-h-[85vh] flex flex-col">
          <CardHeader className="border-b border-gray-200 bg-gradient-to-r from-blue-600 to-purple-600 rounded-t-lg">
          ...
          <CardContent className="flex-1 overflow-y-auto p-6 space-y-6" style={{ maxHeight: "calc(85vh - 200px)" }}>
            {chatHistory.length === 0 ? (
              <div className="text-center py-12">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-6 max-w-2xl mx-auto">
                  <h4 className="font-semibold text-blue-900 mb-4 text-lg">Try asking:</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {suggestedQuestions.map((q, index) => (
                      <button
                        key={index}
                        onClick={() => handleSuggestedQuestion(q)}
                        className="text-left text-sm text-blue-800 bg-white hover:bg-blue-100 p-3 rounded-lg transition-colors border border-blue-200 hover:border-blue-400"
                      >
                        💡 {q}
                      </button>
                    ))}
          ...
          <div className="border-t border-gray-200 p-4 bg-white rounded-b-lg">
            <form onSubmit={handleSubmit} className="flex gap-3">
              <Input
                ...
                className="flex-1 text-base py-6 px-4 rounded-xl border-2 border-gray-200 focus:border-blue-500"
                disabled={loading}
              />
              <Button
                type="submit"
                disabled={loading || !question.trim()}
                className="px-6 py-6 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 rounded-xl"
              >
                {loading ? (
